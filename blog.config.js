...
const BLOG = {
  ...
  SINCE: process.env.NEXT_PUBLIC_SINCE || 2001, // e.g if leave this empty, current year will be used.
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'cnfy', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '没有简介', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.cnfy.me', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'cnfy, blog, 飞扬, cnfeiyang', // 网站关键词 英文逗号隔开
