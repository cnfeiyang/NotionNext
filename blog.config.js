...
const BLOG = {
  AUTHOR: 'Cnfy', // 作者
  BIO: '谁也不知道要发生什么，所以要把发生的记录下来', // 作者简介
  LINK: 'https://cnfy.me', // 网站地址
  KEYWORDS: 'cnfy, 飞扬, blog, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'e7c1e40f6f094f5889b8b20c77fe5c12', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'cnfeiyang@gmail.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: 'https://twitter.com/cnfeiyang', // 你的twitter个人主页
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Cnfy BLOG', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
